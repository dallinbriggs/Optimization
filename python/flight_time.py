...
def obj_func(x):
    ...
    eng_displace, fuel_rate, omega_r, R_rotor, fuel_cap, theta_hover = unscale(x)
    ...
    ft, c, dft_dx, dc_dx = flight_time(eng_displace, fuel_rate, omega_r, R_rotor, fuel_cap, theta_hover, n_rotors, payload, frame, rho_air, E_rhof, n_engine)
    return -ft, -c
...
def scale(x):
    eng_displace, fuel_rate, omega_r, R_rotor, fuel_cap, theta_hover = x
    ...
    return [eng_displace, fuel_rate, omega_r, R_rotor, fuel_cap, theta_hover]
...
def simple_aero_model(AUW, omega, R_rotor, c_rotor, theta_hover, rho_air, n_rotors):
